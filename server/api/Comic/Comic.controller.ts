 ...
 */
export function addContributorToComicContributors(req, res, next) : Comic {
...
export function searchForComics(req, res, next) : void{
...
export function searchForComicsByUsername(req, res, next) : void {
  var keywords = String(req.params.keywords);
...
export function destroy(req, res) : void {
  Comic.findByIdAsync(req.params.id)
    .then(handleEntityNotFound(res))
